    ...
    <div className="rr-page">
      ...
      <form onSubmit={handleSubmit} className="rr-form-grid">
        <div className="field-group">
          <div className="field">
            <label>{t('pages.auto.name', 'Naam')}</label>
            <input
              name="naam"
              type="text"
              required
              defaultValue={draft?.naam || ''}
              placeholder={t('pages.auto.name.placeholder', 'Bijv. TUV keuring')}
            />
          </div>

          <div className="field">
            <label>{t('pages.auto.datum', 'Vervaldatum')}</label>
            <input
              name="datum"
              type="date"
              required
