...
export default function Overheid() {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedDate < new Date()) {
      toastReminder(t("overheid.validation.datePast") || "Datum/tijd mag niet in het verleden liggen.");
      return;
    }
  ...
  const handleDelete = (id) => { removeItem(id); toastReminder(t("overheid.toast.deleted") || "Herinnering verwijderd."); };

  return (
    <SectionCard title={t("pages.overheid.title", "Overheid")}>
