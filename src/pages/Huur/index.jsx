...
export default function Huur() {
  ...
  return (
    <div className="rr-page">
      <h2>{t('pages.huur.title', 'Huurcontract')}</h2>

      {/* ✅ FORMULIER */}
      <form onSubmit={handleSubmit} className="rr-form-grid">
        <div className="field-group">
          <div className="field">
            <label>{t('pages.huur.name', 'Naam')}</label>
            <input
              name="naam"
              type="text"
              required
              defaultValue={draft?.naam || ''}
              placeholder={t('pages.huur.name.placeholder', 'Bijv. Huurcontract appartement')}
            />
          </div>

          <div className="field">
            <label>{t('pages.huur.datum', 'Vervaldatum')}</label>
            <input
              name="datum"
              type="date"
              required
