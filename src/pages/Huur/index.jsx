...
export default function Huur() {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedDate < new Date()) {
      toastReminder(t("huur.validation.datePast") || "Datum/tijd mag niet in het verleden liggen.");
      return;
    }
  ...
  const handleDelete = (id) => { removeItem(id); toastReminder(t("huur.toast.deleted") || "Herinnering verwijderd."); };

  return (
    <SectionCard title={t("pages.huur.title", "Huur")}>
