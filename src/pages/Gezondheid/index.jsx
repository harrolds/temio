...
export default function Gezondheid() {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedDate < new Date()) {
      toastReminder(t("gezondheid.validation.datePast") || "Datum/tijd mag niet in het verleden liggen.");
      return;
    }
  ...
  const handleDelete = (id) => { removeItem(id); toastReminder(t("gezondheid.toast.deleted") || "Herinnering verwijderd."); };
