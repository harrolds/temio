...
export default function Gezondheid() {
  ...
  return (
    <div className="rr-page">
      <h2>{t('pages.gezondheid.title', 'Gezondheid')}</h2>

      {/* ✅ FORMULIER */}
      <form onSubmit={handleSubmit} className="rr-form-grid">
        <div className="field-group">
          <div className="field">
            <label>{t('pages.gezondheid.name', 'Naam')}</label>
            <input
              name="naam"
              type="text"
              required
              defaultValue={draft?.naam || ''}
              placeholder={t('pages.gezondheid.name.placeholder', 'Bijv. Huisartscontrole')}
            />
          </div>

          <div className="field">
            <label>{t('pages.gezondheid.datum', 'Datum')}</label>
            <input
              name="datum"
              type="date"
              required
